...
#		  
#  Build the image:                                               		  
#    $ docker build -t postgres:10-alpine --no-cache -f postgres10-alpine.dockerfile .   # longer but more accurate
#    $ docker build -t postgres:10-alpine -f postgres10-alpine.dockerfile .    		     # faster but increase mistakes
#                                                                 		  
#  Run the container:                                             		  
#    $ docker run -it --rm -v $(pwd)/shared:/shared -p 5432:5432 postgres:10-alpine
#    $ docker run -it -p 5432:5432 -v $(pwd)/shared:/shared --name sphinx postgres:10-alpine
#                                                              		  
## LEVEL1 ##########################################################################
...
# Set env variables
ARG DOCKER_SERVICES=${DOCKER_SERVICES:-"postgres/10"}
