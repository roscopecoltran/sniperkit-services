...
# Set env variables
ARG DOCKER_SERVICES=${DOCKER_SERVICES:-"go"}
ARG DOCKER_SHARED_FOLDERS=${DOCKER_SHARED_FOLDERS:-"src,bin,pkg,ssl,load,conf.d,logs,data,plugins"}
...
# app configuration
ARG APP_CONF_FILENAME=${APP_CONF:-"app.conf"}
